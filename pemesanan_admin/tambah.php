            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body">
                                <form action="index.php?page=pemesanan_admin/proses_tambah" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="jumlah_pesanan" placeholder="Masukkan Tanggal Pesanan" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_barang">
                                            ...
                                            while ($d = mysqli_fetch_array($query)) {
                                            ?>
                                                <option value="<?= $d['id_barang'] ?>"> <?= $d['harga_barang']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
